...
> **Amendment R20 (Extra Labour, owner-approved 2026-09-22):** added the new **`extra_labour`** resource (navigable — `/dashboard/extra-labour` is a dedicated page), 4 actions covering extra labour staff management and options: `page`, `view`, `create`, `manage`. Default holders: `Manager` (`page`, `view`, `create`, `manage`), `Accountant` (`page`, `view`), `Driver` (`create`), `Vendor Admin` (`*`). **Totals updated: 204 permissions, 31 pages, 35 resources.**
