...
| B-NTF-003 | NTF-003..009 | Orders/Tickets/Payments trigger coverage | High | DONE | Cover admin/staff/customer roles for critical events. |
| B-NTF-004 | NTF-013 | Integration tests for trigger + dedupe behavior | High | DONE | Required before merge to main. |
