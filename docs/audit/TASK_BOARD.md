...
| FE-OPS-006 | vendor-dashboard | `/dashboard/daily-sheets` | Table UX | Add list chips for `issueCount` and `onDemandCount`, plus quick link to Delivery Issues Inbox. | Medium | Agent B | DONE | - | - | Dependency cleared: `API-011` implemented. Proceed with FE list UX. |
