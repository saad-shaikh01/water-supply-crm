...
import { useAddAdhocItem } from '../../hooks/use-daily-sheets';
import { productsApi } from '../../../products/api/products.api';
import { customersApi } from '../../../customers/api/customers.api';

interface AdhocDeliveryDialogProps {
  open: boolean;
  onClose: () => void;
  sheetId: string;
}
...
export function AdhocDeliveryDialog({ open, onClose, sheetId }: AdhocDeliveryDialogProps) {
  const { mutate: addAdhocItem, isPending } = useAddAdhocItem(sheetId);
  ...
  const { data: customerSearchData, isFetching: isSearching } = useQuery({
    queryKey: ['adhoc-customer-search', debouncedQuery],
    queryFn: () =>
