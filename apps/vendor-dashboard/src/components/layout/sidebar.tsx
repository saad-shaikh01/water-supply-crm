...
import {
  ...
  Inbox, Percent, Wallet, Landmark, Gauge, AlertOctagon, PiggyBank, CalendarCheck, Fuel, UserCheck,
} from 'lucide-react';
...
const navItems: NavItem[] = [
  ...
  { label: 'Extra Labour', href: '/dashboard/extra-labour', icon: UserCheck, group: 'Finance' },
...
const GROUPS = ['Driver', 'Operations', 'Payroll', 'Finance', 'Settings'];
